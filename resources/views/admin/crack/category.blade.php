                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-sm-6">
                            <div class="float-sm-right">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#test" data-whatever="@mdo"><i class="fas fa-plus"></i> Add Category</button>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Our Category</h5>
                                    ...
                                    <input type="text" class="form-control" id="2" name="title" required>
                                </div>
                                ...
                                <img src="" alt="Image" id="1" width="100px" height="100px">
...
<script>
    $(document).ready(function() {
        $('.edit-btn').on('click', function() {
            var id = $(this).data('id');
            $('#editForm').attr('action', "{{ route('updatecategory', '') }}" + '/' + id);
            $.ajax({
                type: "GET",
                url: "{{ url('admin/category/edit') }}" + '/' + id,
                success: function(response) {
                    $('#1').attr('src', "{{ asset('public/images/') }}" + '/' + response.image);
                    $('#2').val(response.title);
